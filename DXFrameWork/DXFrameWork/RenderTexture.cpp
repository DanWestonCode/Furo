...
HRESULT RenderTexture::Initialize(ID3D11Device* device, int textureWidth, int textureHeight)
{
...
//Set the ID3D11ShaderResourceView of this class as the current render target
...
//clears the render target (like clearing the backbuffer)
