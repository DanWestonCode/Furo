...
void FluidSolver2D::DensityStep(int gridSize, float* density, float* prevDensity, float* velocityX, float* velocityY, float diffusion, float dt)
{
	//density
...
void FluidSolver2D::Project(int gridSize, float* xVel, float* yVel, float* xVelPrev, float* yVelPrev)
{
	int i, j, k;
	float h;
	h = 1.0f / gridSize;
...
void FluidSolver2D::SetBnds(int gridSize, int b, float* field)
{
...
void FluidSolver2D::AddSource(int gridSize, float* currentSource, float* prevSource, float dt)
{
...
void FluidSolver2D::Diffuse(int gridSize, int b, float* dens, float* prevDens, float diff, float dt)
{
